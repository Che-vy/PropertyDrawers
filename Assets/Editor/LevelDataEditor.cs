...
public class LevelDataEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        //AssetDatabase.GetAssetPath(PrefabUtility.GetPrefabParent(element.))
        //PrefabUtility.GetPrefabParent();
        //assetdatabase.getassetpath(AudioHighPassFilter asset);
        ...
        {
            if (EditorUtility.DisplayDialog("Achtung!", "U sure u finna delete dis b?", "Fosho", "Oh Hell Naw"))
        ...
        list.onAddCallback = (ReorderableList l) =>
        {
            ...
            element.FindPropertyRelative("Prefab").objectReferenceValue = AssetDatabase.LoadAssetAtPath("Assets/Resources/Prefabs/Mobs/snoopdogg.prefab", typeof(GameObject)) as GameObject;
        };

        list.onAddDropdownCallback = (Rect btnRect, ReorderableList l) =>
        {
